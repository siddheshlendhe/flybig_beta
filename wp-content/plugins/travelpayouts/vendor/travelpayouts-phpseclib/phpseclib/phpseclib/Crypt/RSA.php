 ...
 *
 *    $rsa = new \Travelpayouts\Vendor\phpseclib\Crypt\RSA();
...
class RSA
{
    ...
    */
    ...
    /**#@+
     * @access private
     * @see \Travelpayouts\Vendor\phpseclib\Crypt\RSA::createKey()
    */
    /**
     * ASN1 Integer
     */
    ...
    /**#@+
     * @access private
     * @see \Travelpayouts\Vendor\phpseclib\Crypt\RSA::__construct()
    */
    /**
     ...
     * @access public
     * @see \Travelpayouts\Vendor\phpseclib\Crypt\RSA::createKey()
     * @see \Travelpayouts\Vendor\phpseclib\Crypt\RSA::setPrivateKeyFormat()
    */
    /**
     ...
     * @access public
     * @see \Travelpayouts\Vendor\phpseclib\Crypt\RSA::createKey()
     * @see \Travelpayouts\Vendor\phpseclib\Crypt\RSA::setPublicKeyFormat()
    */
    /**
     * Raw public key
     *
     * An array containing two \Travelpayouts\Vendor\phpseclib\Math\BigInteger objects.
     *
     ...
     * Precomputed Zero
     *
     * @var \Travelpayouts\Vendor\phpseclib\Math\BigInteger
     * @access private
     */
    var $zero;
     ...
     * Hash function
     *
     * @var \Travelpayouts\Vendor\phpseclib\Crypt\Hash
     * @access private
     */
    var $hash;
     ...
     * \Travelpayouts\Vendor\phpseclib\Crypt\RSA doesn't do it is because OpenSSL doesn't fail gracefully.  openssl_pkey_new(), in particular, requires
     * openssl.cnf be present somewhere and, unfortunately, the only real way to find out is too late.
     *
     * @return \Travelpayouts\Vendor\phpseclib\Crypt\RSA
     * @access public
     */
     ...
     *                  Will need to be passed back to \Travelpayouts\Vendor\phpseclib\Crypt\RSA::createKey() as the third parameter for further processing.
     *
     * @access public
     * @param int $bits
     * @param int $timeout
    ...
    {
        // \Travelpayouts\Vendor\phpseclib\Crypt\Hash supports algorithms that PKCS#1 doesn't support.  md5-96 and sha1-96, for example.
        switch ($hash) {
            case 'md2':
            case 'md5':
            case 'sha1':
     ...
     * @access private
     * @param \Travelpayouts\Vendor\phpseclib\Math\BigInteger $x
     * @param \Travelpayouts\Vendor\phpseclib\Math\BigInteger $r
     * @param int $i
     * @return \Travelpayouts\Vendor\phpseclib\Math\BigInteger
     */
     ...
     *
     * @access private
     * @param \Travelpayouts\Vendor\phpseclib\Math\BigInteger $m
     * @return \Travelpayouts\Vendor\phpseclib\Math\BigInteger
     */
    function _rsaep($m)
    {
     ...
     *
     * @access private
     * @param \Travelpayouts\Vendor\phpseclib\Math\BigInteger $c
     * @return \Travelpayouts\Vendor\phpseclib\Math\BigInteger
     */
    function _rsadp($c)
    {
     ...
     *
     * @access private
     * @param \Travelpayouts\Vendor\phpseclib\Math\BigInteger $s
     * @return \Travelpayouts\Vendor\phpseclib\Math\BigInteger
     */
    function _rsavp1($s)
    {
     ...
     *
     * As a consequence of this, a private key encrypted ciphertext produced with \Travelpayouts\Vendor\phpseclib\Crypt\RSA may not decrypt
