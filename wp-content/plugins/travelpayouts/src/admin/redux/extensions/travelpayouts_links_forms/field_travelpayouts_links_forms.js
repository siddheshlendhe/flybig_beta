...
(function( $ ) {
    ...
    redux.field_objects.travelpayouts_links_forms = redux.field_objects.travelpayouts_links_forms || {};

    $( document ).ready(
        function() {
            //redux.field_objects.slides.init();

            var parentTable = $('.redux-container-travelpayouts_links_forms').parents('table.form-table');
            parentTable.find('th').css('display', 'block');
            parentTable.find('tr').css('display', 'block');
        }
    );

    redux.field_objects.travelpayouts_links_forms.init = function( selector ) {

        if ( !selector ) {
            selector = $( document ).find( ".redux-group-tab:visible" ).find( '.redux-container-travelpayouts_links_forms:visible' );
        }
        ...
        $( selector ).each(
            function() {
                ...
                if ( parent.hasClass( 'redux-container-travelpayouts_links_forms' ) ) {
                ...
                el.find( '.redux-slides-remove' ).live(
                    'click', function() {
                        ...
                        var slideCount = $( this ).parents( '.redux-container-travelpayouts_links_forms:first' ).find( '.redux-slides-accordion-group' ).length;
