...
use Exception;
use Travelpayouts\Vendor\Monolog\Formatter\LineFormatter;
 ...
 *
 *      $logger = new \Travelpayouts\Vendor\Monolog\Logger('all', array(new \Travelpayouts\Vendor\Monolog\Handler\PHPConsoleHandler()));
 * \Travelpayouts\Vendor\Monolog\ErrorHandler::register($logger);
 *      echo $undefinedVar;
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    private $options = array(
        ...
        'classesPartialsTraceIgnore' => array('Travelpayouts\\Vendor\\Monolog\\'), // array Hide calls of classes started with...
    ...
    /**
     * @param  array          $options   See \Travelpayouts\Vendor\Monolog\Handler\PHPConsoleHandler::$options for more details
