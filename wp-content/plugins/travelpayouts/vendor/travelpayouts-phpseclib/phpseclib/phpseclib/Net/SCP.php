 ...
 *        exit('bad login');
 *    }
 *    $scp = new \Travelpayouts\Vendor\phpseclib\Net\SCP($ssh);
 *
...
class SCP
{
    /**#@+
     * @access public
     * @see \Travelpayouts\Vendor\phpseclib\Net\SCP::put()
     */
    /**
    ...
    /**#@+
     * @access private
     * @see \Travelpayouts\Vendor\phpseclib\Net\SCP::_send()
     * @see \Travelpayouts\Vendor\phpseclib\Net\SCP::_receive()
    */
    /**
     * SSH1 is being used.
     */
     ...
     *
     * @param \Travelpayouts\Vendor\phpseclib\Net\SSH1|\phpseclib\Net\SSH2 $ssh
     * @return \Travelpayouts\Vendor\phpseclib\Net\SCP
     * @access public
     */
     ...
     *
     * By default, \Travelpayouts\Vendor\phpseclib\Net\SCP::put() does not read from the local filesystem.  $data is dumped directly into $remote_file.
     * So, for example, if you set $data to 'filename.ext' and then do \Travelpayouts\Vendor\phpseclib\Net\SCP::get(), you will get a file, twelve bytes
