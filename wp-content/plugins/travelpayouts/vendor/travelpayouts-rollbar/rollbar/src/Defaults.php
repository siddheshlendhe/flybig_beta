...
use Travelpayouts\Vendor\Rollbar\Payload\Notifier;
use Travelpayouts\Vendor\Psr\Log\LogLevel;
...
class Defaults
{
    ...
    private $verbose = \Travelpayouts\Vendor\Rollbar\Config::VERBOSE_NONE;
