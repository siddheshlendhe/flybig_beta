...
class TravelpayoutsSettingsFramework_Extension_travelpayouts_autocomplete_extended extends Redux_Travelpayouts_Extension_Abstract {
    private $c;
    public function __construct( $parent, $path, $ext_class ) {
        $this->c = $parent->extensions['travelpayouts_autocomplete'];
