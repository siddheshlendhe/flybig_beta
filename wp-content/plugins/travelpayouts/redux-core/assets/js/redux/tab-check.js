...
(function( $ ) {
	...
	$.redux.tabCheck = function() {
		...
		$( '.redux-group-tab-link-a' ).click(
			function() {
				...
				if ( ! link.parents( '.postbox-container:first' ).length ) {
					...
					cookieName = 'Redux_Travelpayouts_current_tab_' + redux.optName.args.opt_name;
				} else {
					...
					if ( '' !== boxIndex ) {
						cookieName = 'Redux_Travelpayouts_metabox_' + boxIndex + '_current_tab_' + redux.optName.args.opt_name;
					}
				}
		...
		if ( '' !== tab ) {
			if ( $.cookie( 'Redux_Travelpayouts_current_tab_get' ) !== tab ) {
				$.cookie(
					'Redux_Travelpayouts_current_tab',
					tab,
					{
						expires: 7,
						path: '/'
				...
				$.cookie(
					'Redux_Travelpayouts_current_tab_get',
					tab,
					{
						expires: 7,
						path: '/'
				...
				$.cookie(
					'Redux_Travelpayouts_current_tab_' + redux.optName.args.opt_name,
					tab,
					{
						expires: 7,
						path: '/'
		...
		} else if ( '' !== $.cookie( 'Redux_Travelpayouts_current_tab_get' ) ) {
			$.removeCookie( 'Redux_Travelpayouts_current_tab_get' );
		}
		...
		$( '.redux-container' ).each(
			function() {
				...
				if ( ! $( this ).parents( '.postbox-container:first' ).length ) {
					...
					cookieName = 'Redux_Travelpayouts_current_tab_' + opt_name;
					...
					cookieName = 'Redux_Travelpayouts_metabox_' + boxIndex + '_current_tab_' + opt_name;
