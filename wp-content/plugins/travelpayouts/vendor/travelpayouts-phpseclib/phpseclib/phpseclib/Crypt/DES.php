 ...
 *
 *    $des = new \Travelpayouts\Vendor\phpseclib\Crypt\DES();
 *
 *    $des->setKey('abcdefgh');
 *
 *    $size = 10 * 1024;
...
class DES extends Base
{
     ...
     * @see \Travelpayouts\Vendor\phpseclib\Crypt\DES::_processBlock()
     */
    /**
     ...
     *
     * @see \Travelpayouts\Vendor\phpseclib\Crypt\Base::openssl_mode_names
     * @var array
     * @access private
     */
     ...
     *
     * @see \Travelpayouts\Vendor\phpseclib\Crypt\Base::isValidEngine()
     * @param int $engine
     * @access public
     * @return bool
     */
