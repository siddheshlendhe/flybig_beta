...
use Travelpayouts\Vendor\DI\Definition\Exception\AnnotationException;
...
class AnnotationReader implements DefinitionSource
{
    ...
    public function getAnnotationReader()
    {
        if ($this->annotationReader === null) {
            AnnotationRegistry::registerAutoloadNamespace('Travelpayouts\Vendor\DI\Annotation', __DIR__ . '/../../../');
