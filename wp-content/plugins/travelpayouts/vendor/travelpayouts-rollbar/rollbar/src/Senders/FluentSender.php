...
use Travelpayouts\Vendor\Rollbar\Response;
...
class FluentSender implements SenderInterface
{
    ...
    {
        $this->fluentHost = \Travelpayouts\Vendor\Rollbar\Defaults::get()->fluentHost();
        $this->fluentPort = \Travelpayouts\Vendor\Rollbar\Defaults::get()->fluentPort();
        $this->fluentTag = \Travelpayouts\Vendor\Rollbar\Defaults::get()->fluentTag();
        
        $this->utilities = new \Travelpayouts\Vendor\Rollbar\Utilities();
    ...
    /**
     * @param \Travelpayouts\Vendor\Rollbar\Payload\EncodedPayload $scrubbedPayload
     * @param $accessToken
     * @return Response
     *
