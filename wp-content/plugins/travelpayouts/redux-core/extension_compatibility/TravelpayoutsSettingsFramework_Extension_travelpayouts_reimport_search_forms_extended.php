...
class TravelpayoutsSettingsFramework_Extension_travelpayouts_reimport_search_forms_extended extends Redux_Travelpayouts_Extension_Abstract {
    private $c;
    public function __construct( $parent, $path, $ext_class ) {
        $this->c = $parent->extensions['travelpayouts_reimport_search_forms'];
