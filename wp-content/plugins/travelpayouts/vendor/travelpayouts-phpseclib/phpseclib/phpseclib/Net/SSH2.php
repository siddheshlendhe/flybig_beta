 ...
 *
 *    $ssh = new \Travelpayouts\Vendor\phpseclib\Net\SSH2('www.domain.tld');
 ...
 *    include 'vendor/autoload.php';
 *
 *    $key = new \Travelpayouts\Vendor\phpseclib\Crypt\RSA();
...
namespace Travelpayouts\Vendor\phpseclib\Net;
use Travelpayouts\Vendor\phpseclib\Crypt\Base;
use Travelpayouts\Vendor\phpseclib\Crypt\Blowfish;
use Travelpayouts\Vendor\phpseclib\Crypt\Hash;
use Travelpayouts\Vendor\phpseclib\Crypt\Random;
use Travelpayouts\Vendor\phpseclib\Crypt\RC4;
use Travelpayouts\Vendor\phpseclib\Crypt\Rijndael;
use Travelpayouts\Vendor\phpseclib\Crypt\RSA;
use Travelpayouts\Vendor\phpseclib\Crypt\TripleDES;
use Travelpayouts\Vendor\phpseclib\Crypt\Twofish;
use Travelpayouts\Vendor\phpseclib\Math\BigInteger; // Used to do Diffie-Hellman key exchange and DSA/RSA signature verification.
use Travelpayouts\Vendor\phpseclib\System\SSH\Agent;
...
class SSH2
{
     ...
     *
     * @see \Travelpayouts\Vendor\phpseclib\Net\SSH2::bitmap
     * @access private
     */
     ...
     *     the other side.
     *
     * @see \Travelpayouts\Vendor\phpseclib\Net\SSH2::_send_channel_packet()
     * @see \Travelpayouts\Vendor\phpseclib\Net\SSH2::_get_channel_packet()
     * @access private
    */
    ...
    /**#@+
     * @access public
     * @see \Travelpayouts\Vendor\phpseclib\Net\SSH2::getLog()
    */
    /**
    ...
    /**#@+
     * @access public
     * @see \Travelpayouts\Vendor\phpseclib\Net\SSH2::read()
    */
    /**
     ...
     * @param int $timeout
     * @see self::login()
     * @return \Travelpayouts\Vendor\phpseclib\Net\SSH2
     * @access public
     */
     ...
     * \Travelpayouts\Vendor\phpseclib\Crypt\Base.
     *
     * @param string $algorithm Name of the encryption algorithm
     * @return mixed Instance of \Travelpayouts\Vendor\phpseclib\Crypt\Base or null for unknown
     * @access private
     */
     ...
     * Login
     *
     * The $password parameter can be a plaintext password, a \Travelpayouts\Vendor\phpseclib\Crypt\RSA object or an array
     *
     ...
     *
     * @param string $username
     * @param \Travelpayouts\Vendor\phpseclib\System\SSH\Agent $agent
     * @return bool
     * @access private
     */
     ...
     *
     * @param string $username
     * @param \Travelpayouts\Vendor\phpseclib\Crypt\RSA $privatekey
     * @return bool
     * @access private
     * @internal It might be worthwhile, at some point, to protect against {@link http://tools.ietf.org/html/rfc4251#section-9.3.9 traffic analysis}
     *           by sending dummy SSH_MSG_IGNORE messages.
     ...
     * Execute Command
     *
     * If $callback is set to false then \Travelpayouts\Vendor\phpseclib\Net\SSH2::_get_channel_packet(self::CHANNEL_EXEC) will need to be called manually.
    ...
    function exec($command, $callback = null)
    {
        ...
        // down.  the one place where it might be desirable is if you're doing something like \Travelpayouts\Vendor\phpseclib\Net\SSH2::exec('ping localhost &').
     ...
     *
     * \Travelpayouts\Vendor\phpseclib\Net\SSH2 doesn't properly close most channels.  For exec() channels are normally closed by the server
